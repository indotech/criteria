...
Вероятно большим количеством данных, потому что сообщений может быть много, а боты могут быть большими.

В какой-то момент процесс NodeJS не сможет выделить достаточное количество оперативной памяти и упадет.
...
и ничего из этой функций не возвращать.
